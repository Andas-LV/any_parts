...
export default function ImageCarousel({ images }: ImageCarouselProps) {
    ...
    const isVideo = selectedMedia.endsWith(".mp4") || selectedMedia.endsWith(".webm");
        ...
        <div className={styles.carousel}>
            <div className={styles.thumbnailContainer}>
                ...
                <div className={styles.thumbnails} ref={thumbnailsRef}>
                    {images.slice(scrollIndex, scrollIndex + visibleThumbnails).map((src, index) => (
                        <button
                        ...
                        >
                            {src.endsWith(".mp4") || src.endsWith(".webm") ? (
                                ...
                                <Image src={src} alt={`Thumbnail ${index + 1}`} width={60} height={60} />
                            )}
                        </button>
                    ))}
                </div>
            ...
            <div className={styles.mainMedia}>
                {isVideo ? (
                    ...
                    <Image src={selectedMedia} alt="Main media" width={400} height={300} className={styles.image} />
                )}
            </div>
        </div>
    );
