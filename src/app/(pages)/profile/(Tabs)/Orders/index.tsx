    ...
    if (!isAuthenticated) {
        return <div className={styles.wrapper}>
            ...
            <p className={styles.nonAuth}>
                ...
                <Button variant={"link"} className={styles.linkToLogin}>авторизоваться.</Button>
            </p>
        </div>
    }
        ...
        <div className={styles.wrapper}>
            {isOrders ? (
                <div className={styles.noOrdersWrapper}>
                    ...
                    <p>Загляните на главную, чтобы выбрать товары <br/> или найдите нужное в поиске</p>

                    <Button variant={"outline"} onClick={() => router.push('/')} className={styles.toMainBtn}>
                        Перейти на главную
                    </Button>
                </div>
            ) : (
