...
export default function Purse() {
    ...
    const transActionsExists = Array.isArray(transActions) && transActions.length > 0;
    const groupedTransactions = transActionsExists ? groupTransactionsByDate(transActions) : {};
