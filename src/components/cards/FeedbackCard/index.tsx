...
export default function FeedbackCard({ feedback }: FeedbackCardProps) {
    const { productImage, productName, shopName, images, rating, text, likes, likedByMe, id } = feedback;
    ...
    return (
        <Card className={styles.card}>
            ...
            <div className={styles.commentFooter}>
                ...
                <Button onClick={() => setIsFeedbackOpen(true)} variant="outline" className={styles.replyBtn}>
                    Дополнить отзыв
                </Button>
            </div>
