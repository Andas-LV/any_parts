...
export default function RefundFullInfo({onClose, onNext, onPrev}: {
    onClose: () => void,
    onNext: () => void,
    onPrev: () => void
}) {
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>, optionId: number) => {
        e.stopPropagation();
            ...
            <div className={styles.contentScrollSection}>
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.photoDescription}>
                        Минимум — 1 фото. Но продавцы чаще одобряют подробные заявки: с видео и несколькими фото, на
                        которых хорошо видно причину возврата
                    </p>
