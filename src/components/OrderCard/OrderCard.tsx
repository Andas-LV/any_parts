...
export default function OrderCard({ order }: OrderCardProps) {
    ...
    const { name, orderId, shopName, productName, address, price, status, card, image } = order;

    const [isFeedbackOpen, setIsFeedbackOpen] = useState(false);
    const orderAction =
        getOrderAction(status as StatusChoice, () => setIsFeedbackOpen(true));
            ...
            <CardContent>
                <div className={styles.detailWrapper}>
                    ...
                    <div className={styles.detailInfo}>
                        <div className={styles.label}>{shopName} / {productName}</div>
                ...
                <div className={styles.detailWrapper}>
                    ...
                    <div className={styles.detailInfo}>
                        ...
                        <Button variant="link" className={styles.link}>Посмотреть на карте</Button>
                    </div>
                </div>
                ...
                <div className={styles.detailWrapper}>
                    ...
                    <div className={styles.detailInfo}>
                        ...
                        <Button variant="link" className={styles.link}>Посмотреть</Button>
                    </div>
                </div>
                ...
                <div className={styles.detailWrapper}>
                    ...
                    <div className={styles.detailInfo}>
                        <div className={styles.label}>Сумма {price} ₸</div>
                        <div className={styles.value}>{card.type} •• {card.cardId.toString().slice(-4)}</div>
                    </div>
                </div>
            </CardContent>
            <CardFooter>
